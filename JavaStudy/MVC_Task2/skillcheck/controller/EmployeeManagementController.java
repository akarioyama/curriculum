...
public final class EmployeeManagementController extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // [ここへ記述]
            String resultset = request.getParameter(CONST_REQUST_KEY_FOR_RESPONSE_BEAN);
	...
	@Override
	protected void employeeBean(int i, bean.EmployeeBean resEmployeeBean) {
		// TODO 自動生成されたメソッド・スタブ

	}

	@Override
	protected void employeeBean(int i, int j) {
		// TODO 自動生成されたメソッド・スタブ
	...
	@Override
	protected void employeeBean(int i, String string) {
		// TODO 自動生成されたメソッド・スタブ
