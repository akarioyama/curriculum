...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException, MVCException {
        ...
        try {
            ...
            // ←ここへ記述
        	employeeBean(1, "SELECT_BY_EMPID" );
    ...
    protected abstract void employeeBean(int i, String string);

	protected abstract void EmployeeBean(int i, String string);

	protected abstract void employeeBean(int i, bean.EmployeeBean resEmployeeBean);

	protected abstract void employeeBean(int i, int j);
