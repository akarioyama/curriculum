...
public static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5434/lesson_db";
/** ユーザー名 */
...
public static final String SELECT_BASE = "select * from employee where not createdate=?,updatedate=?,deleteflg=?";
