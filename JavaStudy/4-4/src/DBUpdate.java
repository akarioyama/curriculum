...
public class DBUpdate {
    ...
    private static final String JDBC_CONNECTION = "jbdc:postgres://localhost:5432/lesson_db" ;
    /** ・ユーザー名 */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
            		 "jdbc:postgresql://lacalhost:5432/lesson_db", "postgres", "postgres");
            statement = connection.createStatement();

            // 問⑤ SHOHIN_IDが020のSHOHIN_NAMEを「商品20」に変更するためのSQL文を記述しましょう。
            String SQL = "UPDATE  tb_shohin set SHOHIN_NANE = '商品20' where SHOHIN_ID = 020   " ;
