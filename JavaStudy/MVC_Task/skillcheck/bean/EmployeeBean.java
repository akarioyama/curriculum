 ...
 */
     ...
     */
    public EmployeeBean(String empId, String password, String name, String mail, String programingLanguage, String comment, String updatedate,String deleteFlg) {
        this._empId = empId;
        this._password = password;
        this._name= name;
        this._mail = mail;
    ...
    public void set_updatedate(String _updatedate) {
