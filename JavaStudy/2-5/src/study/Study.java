...
public class Study {
	...
	public static void main(String args[]) {
        ...
        /*
         * 生成したLinkedHashmapクラスをLinkedHashMapインターフェース型の変数shopＭapに保持する。
         * 要素な並びが１の時に、１８０になる。
         *
         */
        ...
        // 「shohinList」と「shopMap」が保持する値を上手く利用しました。
        for(String item_name : shohinList){
            System.out.println(item_name + "=" + shopMap.get(item_name) + "円になります！");
        }
	}
}